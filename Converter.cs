...
/********************************************
    ...
    // inputs and outputs are all strings
    // functions are self-explanatory
    string binaToOcta(string input)
    string binaToDeci(string input)
    string binaToHex(string input)
    string octaToBina(string input)
    string octaToDeci(string input)
    string octaToHex(string input)
    string deciToBina(string input)
    string deciToOcta(string input)
    string deciToHex(string input)
    string hexaToBina(string input)
    string hexaToOcta(string input)
    string hexaToDeci(string input)
    
    // Checks if a number(in string type) is oversized
    bool checkSize(string input, string type)
